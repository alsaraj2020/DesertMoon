...
export default function App({ config }) {
  ...
  async function buyNow() {
    try {
      ...
      setStatus(
        `Success! Received ${fmt(data.purchase.tokenAmount)} ${config.tokenSymbol || "DMOON"}`
      );
      ...
      <main className="page-shell">
        ...
        <section className="panel connect-panel">
          ...
          <div className="wallet-grid">
            <button className="wallet-btn phantom" onClick={() => setVisible(true)}>
              <img src="/assets/phantom.png" alt="Phantom" /><span>Connect Phantom</span>
            </button>
            <button className="wallet-btn solflare" onClick={() => setVisible(true)}>
              <img src="/assets/solflare.png" alt="Solflare" /><span>Connect Solflare</span>
            </button>
            <button className="wallet-btn walletconnect" onClick={() => setVisible(true)}>
              <span className="wc-icon">⌁</span><span>WalletConnect</span>
            </button>
          </div>
